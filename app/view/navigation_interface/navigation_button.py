...
class ToolButton(NavigationButton):
    ...
    def drawIcon(self, painter: QPainter, shearX: int=0, shearY: int=0, x: int=0, y: int=0, ds: int=0):
        """ draw icon """
    ...
    def drawLine(self, painter: QPainter, x1: int, y1: int, x2: int, y2: int, x3: int, y3: int, x4: int, y4: int):
        """ draw selected line """
        painter.setPen(Qt.PenStyle.NoPen)
...
class PushButton(NavigationButton):
    ...
    def drawTextIcon(self, painter: QPainter, shearX: int=0, shearY: int=0, iconX: int=0, iconY: int=0, textX: int=60, textY: int=20, ds: int=0):
        """ draw text and icon """
        # draw icon
        painter.shear(shearX, shearY)
        ...
        # draw text
        color = Qt.GlobalColor.white if config.theme == Theme.DARK else Qt.GlobalColor.black
        painter.setPen(color)
        painter.setFont(self.font())
        text = painter.fontMetrics().elidedText(self.text(), Qt.TextElideMode.ElideRight, 320)
